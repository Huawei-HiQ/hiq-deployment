...
function pkg_download()
{
	...
	wget https://github.com/fredrik-johansson/mpmath/archive/$pkg_ver.tar.gz 1>&2
...
{
    local pkg_dir=$1
    backup_files $pkg_dir control rules python-mpmath-doc.docs
...
EOF
	...
	# rm -v $pkg_dir/debian/python-mpmath-doc.docs
