...
function pkg_download()
{
	...
	wget http://archive.ubuntu.com/ubuntu/pool/universe/s/${pkg_name}/${pkg_name}_${pkg_ver}.orig.tar.gz -P $root 1>&2
    fi
    echo $orig_tar_gz
}
...
EOF
	...
	sed -i -e '/make -f/a export DEB_BUILD_OPTIONS=nocheck' \
