...
Patch0:	    scipy-numpy-deprecation-warnings.patch
...
BuildRequires:	python3-numpy >= 1.8.2
BuildRequires:	python3-numpy-f2py >= 1.8.2
...
pathfix.py -pni "%{__python3} %{python3_shbang_opts}" %{buildroot}%{python3_sitearch}
