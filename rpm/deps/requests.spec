...
Patch0:         requests-certs.py-to-use-the-system-CA-bundle.patch
...
%if 0%{?rhel} && 0%{?rhel} < 8
# CentOS 7
BuildRequires:  python36-chardet
BuildRequires:  python36-idna
BuildRequires:  python36-urllib3
...
%if 0%{?rhel} && 0%{?rhel} < 8
# CentOS 7
Requires:	python36-chardet
Requires:  	python36-idna
...
%{?python_extras_subpkg:%python_extras_subpkg -n python3-requests -i %{python3_sitelib}/*.egg-info security socks}
