...
BuildRequires:	python36-matplotlib
BuildRequires:	python36-Cython
BuildRequires:	python36-numpy >= 1.12
%elif 0%{?mdkver}
# OpenMandriva
BuildRequires:  clang
...
BuildRequires:	python-numpy >= 1.12
%else
# Fedora > 30 && CentOS 8
BuildRequires:	gcc
BuildRequires:	gcc-c++
...
BuildRequires:	python3-numpy >= 1.12
%endif
